...
import { ReservaEventoRequest } from '../../../interfaces';
...
export class FormEvntos implements OnInit, AfterViewInit {
  ...
  atualizarDatasDesabilitadas(): void {
    this.todasDatasDesabilitadas = [...new Set(this.datasSelecionadas)];
  ...
  onSubmit(): void {
    ...
    this.emailService.send('Reserva de Evento', reservaRequest).subscribe({
      next: () => {
