...
describe('FormGinasticaLaboral', () => {
  ...
  let mockEmailService: jasmine.SpyObj<EmailJsService>;

  beforeEach(async () => {
    mockEmailService = jasmine.createSpyObj('EmailJsService', ['send']);

    await TestBed.configureTestingModule({
      imports: [FormGinasticaLaboral, ReactiveFormsModule],
      providers: [
        { provide: EmailJsService, useValue: mockEmailService }
      ]
    }).compileComponents();
  ...
  it('should send email on valid form submission', (done) => {
    mockEmailService.send.and.returnValue(of([]));
  ...
  it('should show error alert on form submission failure', (done) => {
    mockEmailService.send.and.returnValue(
