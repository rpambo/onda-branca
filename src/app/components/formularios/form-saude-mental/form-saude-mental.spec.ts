...
describe('FormSaudeMental', () => {
  ...
  let emailService: jasmine.SpyObj<EmailJsService>;

  beforeEach(async () => {
    const emailServiceSpy = jasmine.createSpyObj('EmailJsService', ['send']);

    await TestBed.configureTestingModule({
      imports: [FormSaudeMental, ReactiveFormsModule],
      providers: [
        { provide: EmailJsService, useValue: emailServiceSpy }
      ]
    }).compileComponents();

    emailService = TestBed.inject(EmailJsService) as jasmine.SpyObj<EmailJsService>;
